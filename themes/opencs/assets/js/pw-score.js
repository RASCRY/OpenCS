...
Score.prototype = {
    ...
    keyboards: {
        QWERTZ: new Keyboard({ // 480/105 = 4.571428571
            ...
            '3': [null, null, '2"', '3§', '€3.38', 'wW', 'eE€'], //4
            '§': [null, null, '2"', '3§', '€3.38', 'wW', 'eE€'], //4
            '4': [null, null, '3§', '€3.38', '5%', 'eE€', 'rR'], //4
            '$': [null, null, '3§', '€3.38', '5%', 'eE€', 'rR'], //4
            '5': [null, null, '€3.38', '5%', '6&', 'rR', 'tT'], //4
            '%': [null, null, '€3.38', '5%', '6&', 'rR', 'tT'], //4
            ...
            'W': ['2"', '3§', 'qQ@', 'wW', 'eE€', 'aA', 'sS'], // 6
            'e': ['3§', '€3.38', 'wW', 'eE€', 'rR', 'sS', 'dD'], // 6
            'E': ['3§', '€3.38', 'wW', 'eE€', 'rR', 'sS', 'dD'], // 6
            '€': ['3§', '€3.38', 'wW', 'eE€', 'rR', 'sS', 'dD'], // 6
            'r': ['€3.38', '5%', 'eE€', 'rR', 'tT', 'dD', 'fF'], // 6
            'R': ['€3.38', '5%', 'eE€', 'rR', 'tT', 'dD', 'fF'], // 6
